...
function Showorientation() {
    ...
    orientationSTR += "<li class='breadcrumb-item active' aria-current='page'><a href='manager-EDITPresentationAssignment.html'>הצגה ועריכה</a></li>";
...
function saveDetails() {
    ...
    Details = {
        "ClassName": TaskObj.ClassName,
        "ClassNumsaveDetails": TaskObj.ClassNum,
